...
<body>
	...
	<div class = "storeetc">
		...
		<div class = "store_etc_image">
				<article>
					<a href = "#"><img src = "http://localhost:9000/myjeju/images/store/store1.png" style = "display:block;"><p>[잡화] 감귤 타르트</p></a>
					<a href = "#"><img src = "http://localhost:9000/myjeju/images/store/store2.png" style = "display:block;"><p>[잡화] 제주 오메기떡</p></a>
					<a href = "#"><img src = "http://localhost:9000/myjeju/images/store/store3.png" style = "display:block;"><p>[잡화] 제주도 한라봉</p></a>
				</article>
