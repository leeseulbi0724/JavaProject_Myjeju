		...
		<section class ="setup_faq_list">
			<table class = "content_layout_setup_faq">
				...
				<tr>
					...
					%>
						<li class="active_page" ><a href="admember.do?pnum=<%= pageNumber %>&search=<%= search %>&search_text=<%= search_text %>" style="background-color: #337ab7;color: #ffffff;"><%= pageNumber %></a></li>
					<%
					...
					%>
						<li><a href="admember.do?pnum=<%= startPage + 10 %>&search=<%= search %>&search_text=<%= search_text %>" style= "color: #000000;"><span>></span></a></li>
					<%
						} else {
					%>
						<li><span style="color: gray;">></span></li>
