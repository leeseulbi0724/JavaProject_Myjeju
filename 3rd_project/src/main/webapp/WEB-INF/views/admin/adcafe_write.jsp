...
<body style="height:900px">
	...
	<div class = "content_setup_faq">
		...
		<section class = "section_setup_faq">
			...
			<form name="admin_cafe" action="adcafe_write_proc.do" method="post" enctype= "multipart/form-data">			
			<table class="table">
		 		<tr>
		 			<th class="title">이름</th>
		 			<th><input type="text" class="form-control" placeholder="상호명을 입력해주세요" id="name" name="ca_name"></th>
		 			<th class="title">해시태그</th>
		 			<th><input type="text" class="form-control" placeholder="해시태그를 입력해주세요" id="tag" name="ca_tag"></th>
		 			<th class="title">종류</th>
		 			<th><input type="text" class="form-control" placeholder="종류를 입력해주세요" id="category" name="ca_infor"></th>
		 		</tr>
		 		<tr>
		 			<th class="title">설명</th>
		 			<th colspan="5"><textarea class="form-control" placeholder="설명을 입력해주세요" id="info" name="ca_infor2" style="height:100px;"></textarea></th>
		 		</tr>	
		 		<tr>
		 			<th class="title">주소</th>
		 			<th colspan="4">
		 				<input type="text" class="form-control" placeholder="주소를 입력해주세요" name="ca_addr1"  id="addr1">
		 				<input type="text" class="form-control" placeholder="상세를 입력해주세요" name="ca_addr2"  id="addr2">			 				
		 			</th>	
		 		...
		 		<tr>
		 			...
		 			<th><input type="text" class="form-control" placeholder="경도를 입력해주세요" id="vpoint" name="ca_vpoint"></th>
		 			<th class="title">위도</th>
		 			<th><input type="text" class="form-control" placeholder="위도를 입력해주세요" id="hpoint" name="ca_hpoint"></th>
		 			<th class="title">연락처</th>
		 			<th><input type="text" class="form-control" value="(+82)" placeholder="연락처를 입력해주세요" id="hp" name="ca_hp"></th>
		 		</tr>	
		 		<tr>
