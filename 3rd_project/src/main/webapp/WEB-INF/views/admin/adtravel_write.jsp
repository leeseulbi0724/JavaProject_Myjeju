...
<body style="height:900px">
	...
	<div class = "content_setup_faq">
		...
		<section class = "section_setup_faq">
			...
			<form name="admin_travel" action="adtravel_write_proc.do" method="post" enctype= "multipart/form-data">			
			<table class="table">
		 		<tr>
		 			...
		 			<th><input type="text" class="form-control" placeholder="종류를 입력해주세요" id="category" name="t_infor"></th>
		 		</tr>
		 		<tr>
		 		...
		 		<tr>
		 			...
		 			<th colspan="4">
		 				<input type="text" class="form-control" placeholder="주소를 입력해주세요" name="t_addr1"  id="addr1">
		 				<input type="text" class="form-control" placeholder="상세를 입력해주세요"name="t_addr2"  id="addr2">	
		 			</th>	
		 		...
		 		<tr>
		 			...
		 			<th><input type="text" class="form-control" placeholder="경도를 입력해주세요" id="vpoint" name="t_vpoint"></th>
		 			<th class="title">위도</th>
		 			<th><input type="text" class="form-control" placeholder="위도를 입력해주세요" id="hpoint" name="t_hpoint"></th>
		 			<th class="title">연락처</th>
		 			<th><input type="text" class="form-control" value="(+82)" placeholder="연락처를 입력해주세요" id="hp" name="t_hp"></th>
		 		</tr>	
		 		<tr>
