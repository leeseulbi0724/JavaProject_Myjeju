...
<body style="height:900px">
	...
	<div class = "content_setup_faq">
		...
		<section class = "section_setup_faq">
			...
			<form name="admin_food" action="adfood_update_proc.do" method="post" enctype= "multipart/form-data">			
			<table class="table">
		 		<tr>
		 			<th class="title">이름</th>
		 			<th><input type="text" class="form-control" placeholder="상호명을 입력해주세요" id="name" name="f_name" value="${vo.f_name }"></th>
		 			<th class="title">해시태그</th>
		 			<th><input type="text" class="form-control" placeholder="해시태그를 입력해주세요" id="tag" name="f_tag" value="${vo.f_tag }"></th>
		 			<th class="title">종류</th>
		 			<th><input type="text" class="form-control" placeholder="종류를 입력해주세요" id="category" name="f_infor" value="${vo.f_infor }"></th>
		 		</tr>
		 		<tr>
		 		...
		 		<tr>
		 			...
		 			<th colspan="4">
		 				<input type="text" class="form-control" placeholder="주소를 입력해주세요" name="f_addr"  id="addr" value="${vo.f_addr }">
		 		...
		 		<tr>
		 			...
		 			<th><input type="text" class="form-control" placeholder="경도를 입력해주세요" id="vpoint" name="f_vpoint" value="${vo.f_vpoint }"></th>
		 			<th class="title">위도</th>
		 			<th><input type="text" class="form-control" placeholder="위도를 입력해주세요" id="hpoint" name="f_hpoint" value="${vo.f_hpoint }"></th>
		 			<th class="title">연락처</th>
		 			<th><input type="text" class="form-control" value="(+82)" placeholder="연락처를 입력해주세요" id="hp" name="f_hp" value="${vo.f_hp }"></th>
		 		</tr>	
		 		<tr>
		 		...
		 		<tr>
		 			...
		 			<th colspan="7">
				 		<c:forEach var="vo"  items="${list}">
			 				<div>
			 					<input type="text" class="form-control"  id="file" readonly value="${vo.f_file }" name="${vo.f_sfile }">
			 					<button type="button" class="minus">-</button>
			 				</div>
		 					<span class="file_name">${vo.f_file},</span>		 					
		 					<span class="sfile_name">${vo.f_sfile},</span>
				 		</c:forEach>
		 			</th>		 			
		 		</tr> 		
		 	</table>
		 		<input type="hidden" name="fid" value="${vo.fid }">
		 		<input id="file_name" type="hidden" name="f_file">
		 		<input id="sfile_name"  type="hidden" name="f_sfile">
