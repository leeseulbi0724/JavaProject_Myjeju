			...
			<div class="detail_image2">
				...
				<div class="detail_image3">
					<div class="detail_roominfo">
						<div class="room_main"><a href="http://localhost:9000/myjeju/calendar.do?hid=${vo.hid}&hdid=${vo.hdid}"><img src="http://localhost:9000/myjeju/images/house/house_detail/${vo.hd_img }"></a></div>
