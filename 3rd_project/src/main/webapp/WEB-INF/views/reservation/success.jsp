...
<link rel="stylesheet" href="http://localhost:9000/myjeju/css/reservation/reserresult.css">
...
<body>
	...
	<section class="reservationDetail">
		<div class="content">
			<h3 style="margin-bottom: 30px;">예약성공</h3>
			<div class="subname">예약에 성공 했습니다.</div>
